...
interface RoueHeaderProps {
  balance: number;
  isLoading?: boolean;
}

export function RoueHeader({ balance, isLoading }: RoueHeaderProps) {
  return (
    <header className="px-4 pt-3">
      ...
      <div className="mt-4 text-center">
        <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-casino-purple-glow/80">
          Bonus quotidien
        </p>
        ...
        <p className="mt-1 text-xs text-white/40">
          Un tour gratuit toutes les 24 h
        </p>
      </div>
    </header>
  );
